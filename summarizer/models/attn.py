...
def train_main():
    ...
    keep_only_a_subset,subset_size = True, 30600
    ...
    with open(atn_dec_file,'wb') as f:
...
def load_ed():
    with open(enc_file,'rb') as f:
        e2 = pickle.load(f)
    with open(atn_dec_file,'rb') as f:
        ad2 = pickle.load(f)

def eval_ed(doc):
    doc = doc.lower()
    attn_dec_summary,_ = evaluate(e2,ad2,stri)
    return attn_dec_summary
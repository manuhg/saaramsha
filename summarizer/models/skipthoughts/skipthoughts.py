...
def load_model(path_to_model_data='summarizer/models/skipthoughts/models/'):
    global path_to_models, path_to_tables, path_to_umodel, path_to_bmodel
    ...
    path_to_tables = path_to_model_data
